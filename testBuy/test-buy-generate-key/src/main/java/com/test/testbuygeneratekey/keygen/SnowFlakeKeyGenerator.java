...
public class SnowFlakeKeyGenerator implements KeyGenerator {
    ...
    public synchronized Number generatorKey() {
        ...
        if (this.sequence==currentMillis){
        ...
        return Long.valueOf(currentMillis-EPOCH<<22 | workerId<<22 | this.sequence);
    }
