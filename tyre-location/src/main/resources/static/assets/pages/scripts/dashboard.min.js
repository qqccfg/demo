                ...
                if (0 != $("#site_activities").size()) {
                    ...
                    $.ajax({
                        ...
                        success : function (result, status) {
                            if (result.code==200){
                                l = new Array()
                                var temporary = result.data
                                for (val in temporary){
                                    l.push([val.toString(),temporary[val]])
                                }
                                $("#site_activities_loading").hide(), $("#site_activities_content").show();
                                //var l = [["2018/10", 300], ["2018/11", 600], ["2018/12", 600], ["2019/01", 900], ["2019/02", 860], ["2019/03", 800], ["2019/04", 1000], ["2019/05", 1000], ["2019/06", 1000], ["2019/07", 600], ["2019/08", 600], ["2019/09", 600]];
